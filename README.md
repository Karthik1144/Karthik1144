...
- Architected transactional backend logic with Spring Data JPA + PostgreSQL to eliminate duplicate reservations
- Increased booking throughput by **30%** through query tuning and indexing
- Built a high-performance, responsive React frontend
...
- Secured endpoints using Spring Security with JWT
- Built interactive data visualization dashboards
- Reduced discretionary spending insights by **20%** through analytics
...
- 🍃 MongoDB Developer Certification — MongoDB University (2025)
- 🗣️ Cambridge Linguaskill General English (CEFR B2) — 2024
